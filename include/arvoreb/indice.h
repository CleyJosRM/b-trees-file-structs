 ...
 * @param[in]   modo        Modo de abertura ("rb", "wb+", "r+b", etc.)
 *
 ...
 *                durante operações de escrita e restaurado ao fechar
 ...
 *
 * @remarks     - A complexidade é O(log n) onde n é o número de entradas
 *              - Não modifica o estado do arquivo de índice
 ...
 * @return      void
 *
 * @remarks     - Se a chave não existe, a operação é um no-op (sem efeito)
 ...
 *              - Complexidade: O(log n) em operações de rebalanceamento
 */
